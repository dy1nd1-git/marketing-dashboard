  ...
  return (
    <html lang="en" className={`${manrope.variable} h-full antialiased`}>
      <head>
        ...
        {/* display=optional: font used only if cached; no swap after paint — eliminates icon FOUC */}
        {/* eslint-disable-next-line @next/next/no-page-custom-font */}
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0..1,0&display=optional" />
      </head>
